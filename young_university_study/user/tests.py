...
def setUpTestData(cls):
        ...
        cls.league_branch1 = LeagueBranch.objects.create(college=cls.college1, name="test团支部1")
        cls.league_branch2 = LeagueBranch.objects.create(college=cls.college2, name="test团支部2")
        cls.league_branch3 = LeagueBranch.objects.create(college=cls.college2, name="test团支部3")
        cls.user1 = User.objects.create(id =10001, name="test用户", identity=1, code='111', uid=111, college=cls.college1, league_branch=cls.league_branch1, total_study=2)
        cls.user2 = User.objects.create(id =10003, name="test用户1", identity=1, code='112', uid=112, college=cls.college1, league_branch=cls.league_branch1, total_study=3)
        cls.user3 = User.objects.create(id =10004, name="test用户2", identity=1, code='113', uid=113, college=cls.college2, league_branch=cls.league_branch2, total_study=3)
        ...
        Permission.objects.create(user_id=cls.user1, permission_type=ContentType.objects.get_for_model(College), permission_id=cls.college1.id)
        StudyRecording.objects.create(user_id=cls.user1, study_id=cls.study_period1, score=1)
        StudyRecording.objects.create(user_id=cls.user1, study_id=cls.study_period2, score=1)
        StudyRecording.objects.create(user_id=cls.user2, study_id=cls.study_period2, score=1)
        StudyRecording.objects.create(user_id=cls.user3, study_id=cls.study_period1, score=1)
...
class UserPermissionTests(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.league_branch1 = LeagueBranch.objects.create(college=cls.college1, name="test团支部1")
        cls.league_branch2 = LeagueBranch.objects.create(college=cls.college2, name="test团支部2")
        cls.user1 = User.objects.create(id =10001, name="test用户", identity=1, code='111', uid=111, college=cls.college1, league_branch=cls.league_branch1)
        cls.superuser = User.objects.create(id =10002, name="super用户", identity=1, code='1111', uid=1111, is_superuser=True)
        Permission.objects.create(user_id=cls.user1, permission_type=ContentType.objects.get_for_model(College), permission_id=cls.college1.id)
        Permission.objects.create(user_id=cls.user1, permission_type=ContentType.objects.get_for_model(LeagueBranch), permission_id=cls.league_branch2.id)

    def test_user_has_college_permission(self):
        self.assertTrue(user_has_college_permission(self.user1, self.college1.id))
        self.assertFalse(user_has_college_permission(self.user1,self.college2.id))
        self.assertTrue(user_has_college_permission(self.superuser, self.college2.id))
        self.assertTrue(user_has_college_permission(self.superuser, self.college1.id))

    def test_user_has_league_permission(self):
        self.assertTrue(user_has_league_permission(self.user1, self.college1.id, self.league_branch1.id))
        self.assertTrue(user_has_league_permission(self.user1,self.college2.id, self.league_branch2.id))
        self.assertTrue(user_has_league_permission(self.superuser, self.college1.id, self.league_branch1.id))
        self.assertTrue(user_has_league_permission(self.superuser,self.college2.id, self.league_branch2.id))
...
class SuperUserTests(APITestCase):
    ...
    def test_user_me_put(self):
        url = '/api/user/me/'
        response: Any = self.client.put(url, data = {'college':1}, format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_college_destory_failed(self):
        url = '/api/college/1/'
        self.assertRaises(ProtectedError, self.client.delete, url, format='json')
    ...
    def test_permission_create(self):
        url = '/api/permission/'
        data = {'user_id': 10003, 'permission_type': ContentType.objects.get_for_model(LeagueBranch).id, 'permission_id': 1}
        response:Any = self.client.post(url,data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
...
class CollegeAdminUserTests(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        setUpTestData(cls)
        Permission.objects.create(user_id=cls.user2, permission_type=ContentType.objects.get_for_model(College), permission_id=cls.college1.id)
    ...
    def test_user_me_put(self):
        url = '/api/user/me/'
        response:Any = self.client.put(url, data = {'college':2}, format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_permission_create_2(self):
        url = '/api/permission/'
        data = {'user_id': 10003, 'permission_type': ContentType.objects.get_for_model(LeagueBranch).id, 'permission_id': 2}
        response:Any = self.client.post(url,data, format='json')
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
...
class LeagueBranchUserTests(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        setUpTestData(cls)
        Permission.objects.create(user_id=cls.user2, permission_type=ContentType.objects.get_for_model(LeagueBranch), permission_id=cls.league_branch1.id)
