...
class UserPermissionTests(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        Permission.objects.create(
            user_id=cls.user1,
            permission_type=ContentType.objects.get_for_model(LeagueBranch),
            permission_id=cls.league_branch2.id,
        )
...
class SuperUserTests(APITestCase):
    ...
    def test_permission_create(self):
        ...
        data = {
            "user_id": 10003,
            "permission_type": ContentType.objects.get_for_model(LeagueBranch).id,
            "permission_id": 1,
        }
        response: Any = self.client.post(url, data, format="json")
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
...
class CollegeAdminUserTests(APITestCase):
    ...
    def test_league_branch_create1(self):
        url = "/api/league_branch/"
...
class LeagueBranchUserTests(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        Permission.objects.create(
            user_id=cls.user2,
            permission_type=ContentType.objects.get_for_model(LeagueBranch),
            permission_id=cls.league_branch1.id,
        )
