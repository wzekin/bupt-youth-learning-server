...
class LeagueBranch(models.Model):
    ...
    college = models.ForeignKey(
        College, verbose_name="学院", null=False, db_index=True, on_delete=models.PROTECT
    )
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    identity = models.SmallIntegerField("学生身份", null=False, choices=IDENTITY_CHOICES)

    is_superuser = models.BooleanField(default=False)
    is_staff = models.BooleanField(default=False)
    is_active = models.BooleanField(default=True)

    code = models.CharField("微信openid", max_length=100, null=False, unique=True)
