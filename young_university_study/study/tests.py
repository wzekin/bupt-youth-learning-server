...
from .models import StudyPeriod
...
class StudyPeriodTests(APITestCase):
    ...
    def test_period_create(self):
        ...
        data = {"season": 1, "period": 3, "name": "test3", "url": "url", "time": 300}
...
class StudyRecordingTests(APITestCase):
    ...
    def test_create1(self):
        StudyRecording.objects.create(
            user_id=self.superuser, study_id=self.study_period1, score=1
        )
        StudyRecording.objects.create(
            user_id=self.superuser, study_id=self.study_period2, score=1
        )
        StudyRecording.objects.create(
            user_id=self.superuser, study_id=self.study_period3, score=1
        )
        StudyRecording.objects.create(
            user_id=self.superuser, study_id=self.study_period4, score=1
        )
        StudyRecording.objects.create(
            user_id=self.superuser, study_id=self.study_period5, score=1
        )
